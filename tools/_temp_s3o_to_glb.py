    ...
    def add_animation(self, anim_name: str, tracks: list,
        ...
        for piece, axis_tracks in trans_by_piece.items():
            ...
            for t in all_times:
                ...
                if piece == "body1" and anim_name == "ActivateOpen" and len(vecs) == 0:
                    print(f"  TRACE body1 t={t:.3f}: rest={rest}, interp_y={_interp(axis_tracks, 1, t):.2f}, y={y:.2f}, 1_in_tracks={1 in axis_tracks}")
                vecs.extend([x, y, z])
